...
public class Game extends Canvas implements Runnable 
{
	...
	Textures tex;
	public static int eregenCost = 25, stealCost = 500, milkCost = 100, luckerCost = 250, hyperCost = 1500, invCost = 3000, nukeCost = 2000, stopCost = 1000, hpregenCost = 150, healthCost = 500;
	public static enum STATE {MENU, GAME, HOWTOPLAY, FACTIONPICK,};
		...
		while (running) 
		{
			...
			if (System.currentTimeMillis() - timer > 1000) 
			{
				...
				if (State == STATE.GAME && pause == false && endgame == false) 
				{
					...
					else if (ENERGY != 100 && ENERGY >= 0 && !active) // energy regeneration
						ENERGY += eregen;
					if (ENERGY >= 100)
						ENERGY = 100;
	...
	private void tick() 
	{
		if (State == STATE.GAME) 
		{
			...
			{
				EntityE tempEnt = Controller.ee.get(i);
		...
		for (int i = 0; i < Controller.eb.size(); i++) 
		{
			EntityB tempEntB = Controller.eb.get(i);
			...
			{// enemy bullet AI
				...
				if (tempEntB.getBoss() == true) 
				{
					...
					c.addEntity(new EnemyBullet(tempEntB.getX() + 16, tempEntB.getY() + 16, tex, x, y, 10 * currentLevel));
			}
		}
		for (int i = 0; i < Controller.ec.size(); i++) 
		{
			EntityC tempEnt = Controller.ec.get(i);
	...
	private void render() 
	{
		...
		if (State == STATE.GAME) 
		{
			...
			else if (Player.nextmap != Player.currentmap && started == false) 
			{
				g.drawImage(Player.nextmap, 0, 0, 600, getHeight(), this);
			}
			p.render(g);
			c.render(g);
			hud.render(g);
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		if (State == STATE.GAME) 
		{
			...
			else if (key == KeyEvent.VK_RIGHT && !shooting) 
			{// right shooting
				shooting = true;
				playerShot.play();
			...
			else if (key == KeyEvent.VK_LEFT && !shooting) 
			{// left shooting
				shooting = true;
				playerShot.play();
				if (!crazy && !akimbo && !cannon)
			...
			else if (key == KeyEvent.VK_DOWN && !shooting) 
			{// down Shooting
				shooting = true;
				playerShot.play();
				if (!crazy && !akimbo && !cannon)
			...
			else if (key == KeyEvent.VK_UP && !shooting) 
			{// up shooting
				shooting = true;
				playerShot.play();
				if (!crazy && !akimbo && !cannon)
	...
	public static void boolListFalse() // resetting enemies
	{
		a1 = false;
		a2 = false;
		a3 = false;
	...
	{
		if (Map.Location == Map.MAP.a1 && Controller.ec.size() == 0) 
		{
			...
			if (!a1) 
			{
				...
				Controller.rewards = 5;
			}
		}
		if (Map.Location == Map.MAP.a2 && Controller.ec.size() == 0) 
		{
			...
			if (!a2) 
			{
				...
				Controller.rewards = 3;
			}
		}
		if (Map.Location == Map.MAP.a3 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.b1 && Controller.ec.size() == 0)
		{
		...
		if (Map.Location == Map.MAP.b2 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.b3 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.c2 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.d2 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.e2 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.e3 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(575, 575, 25, 25));
			c.addEntity(new Wall(-5, -5, 610, 25));// top
		}
		if (Map.Location == Map.MAP.e4 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.e5 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.f2 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, -10, 30, 270));
			c.addEntity(new Wall(0, 360, 30, 300));
			if (!f2) 
		...
		if (Map.Location == Map.MAP.f3 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.f4 && Controller.ec.size() == 0) 
		{
			...
			if (!f4) 
			{
				...
				Controller.rewards = 4;
			}
		}
		if (Map.Location == Map.MAP.f5 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 25, 600));
		...
		if (Map.Location == Map.MAP.f10 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.f9 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 600, 29));
		...
		if (Map.Location == Map.MAP.f8 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.g1 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 25, 610));// left
			c.addEntity(new Wall(-5, -5, 610, 25));// top
		...
		if (Map.Location == Map.MAP.g3 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-20, 575, 25, 640));
			c.addEntity(new Wall(575, -5, 25, 610));// right
			if (!g3) 
		...
		if (Map.Location == Map.MAP.g4 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 25, 600));
		...
		if (Map.Location == Map.MAP.g5 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.g9 && Controller.ec.size() == 0) 
	{
		...
		if (Map.Location == Map.MAP.g8 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 29, 600));
		...
		if (Map.Location == Map.MAP.g10 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 29, 600));
			c.addEntity(new Wall(571, 0, 29, 600));
		...
		if (Map.Location == Map.MAP.h2 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 25 , 610));//left
			if (!h2) 
			{
		...
		if (Map.Location == Map.MAP.h3 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(575, -5, 25, 610));//right
			if (!h3) 
			{
		...
		if (Map.Location == Map.MAP.h4 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.h5 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 25, 600));
		...
		if (Map.Location == Map.MAP.h6 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 25 , 610));//left
			c.addEntity(new Wall(-5, -5, 610 , 25));//top
			if (!h6) 
		...
		if (Map.Location == Map.MAP.h7 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 610 , 25));//top
			c.addEntity(new Wall(-5, 575, 610, 25));//bottom
			if (!h7) 
		...
		if (Map.Location == Map.MAP.h8 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 610 , 25));//top
			c.addEntity(new Wall(-5, 575, 610, 25));//bottom
			if (!h8) 
		...
		if (Map.Location == Map.MAP.h9 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 249, 25));
			c.addEntity(new Wall(349, 0, 600, 25));
			c.addEntity(new Wall(575, -5, 25, 610));//right
		...
		if (Map.Location == Map.MAP.i1 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 25 , 610));//left
			c.addEntity(new Wall(-5, -5, 610 , 25));//top
			c.addEntity(new Wall(-5, 575, 610, 25));//bottom
		...
		if (Map.Location == Map.MAP.i2 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.i3 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.i4 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.i5 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.i6 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(-5, -5, 25 , 610));//left
			c.addEntity(new Wall(575, -5, 25, 610));//right
			if (!i6) 
		...
		if (Map.Location == Map.MAP.j1 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 25, 600));
		...
		if (Map.Location == Map.MAP.j2 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 25, 600));
		...
		if (Map.Location == Map.MAP.j3 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.j4 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.j5 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.j6 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.k1 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 25, 600));
			c.addEntity(new Wall(0, 575, 249, 25));
		...
		if (Map.Location == Map.MAP.k2 && Controller.ec.size() == 0) {
			c.addEntity(new Wall(0, 0, 25, 600));
			c.addEntity(new Wall(275, -10, 50, 620));
			c.addEntity(new Wall(575, -5, 25, 610));//right
			if (!k2) 
		...
		if (Map.Location == Map.MAP.k6 && Controller.ec.size() == 0) {
			c.addEntity(new Wall(-5, -5, 25 , 610));//left
			c.addEntity(new Wall(575, -5, 25, 610));//right
			if (!k6) 
			{
		...
		if (Map.Location == Map.MAP.l1 && Controller.ec.size() == 0) {
			c.addEntity(new Wall(0, 0, 249, 25));
			c.addEntity(new Wall(349, 0, 600, 25));
		...
		if (Map.Location == Map.MAP.l2 && Controller.ec.size() == 0) {
			c.addEntity(new Wall(0, 595, 610, 25));
			c.addEntity(new Wall(0, 595, 610, 25));
		...
		if (Map.Location == Map.MAP.l6 && Controller.ec.size() == 0) {
			c.addEntity(new Wall(-5, -5, 25 , 610));//left
			c.addEntity(new Wall(575, -5, 25, 300));
		...
		if (Map.Location == Map.MAP.l7 && Controller.ec.size() == 0) 
		{
		...
		if (Map.Location == Map.MAP.l8 && Controller.ec.size() == 0) 
		{
			c.addEntity(new Wall(0, 0, 600, 24));
